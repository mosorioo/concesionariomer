...
import com.taller.concesionario.jwt.JwtEntryPoint;
import com.taller.concesionario.jwt.JwtTokenFilter;
import com.taller.concesionario.service.UserDetailsServiceImpl;
...
public class MainSecurity extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        //http.headers().addHeaderWriter(new StaticHeadersWriter("Access-Control-Allow-Mapping", "/**"));
        
    }

    //todo lo que venga x /usuario lo permite pasar, lo que sea tipo Option
    // @Override
	// public void configure(WebSecurity web) throws Exception {
	// 	web.ignoring().antMatchers(HttpMethod.OPTIONS, "/**");
    // 	web.ignoring().antMatchers(HttpMethod.OPTIONS, "/usuario/**"); 
	// }
}
